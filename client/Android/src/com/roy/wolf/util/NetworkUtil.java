...
//		}
	...
	public static String[] getNetWorkInfo(Context context) {
		...
		if(info != null) {
			...
			networkInfo[0] = (info.getTypeName() == null ? "" : info.getTypeName());
			networkInfo[1] = (info.getExtraInfo() == null ? "" : info.getExtraInfo());
			networkInfo[2] = (info.getSubtypeName() == null ? "" : info.getSubtypeName());
